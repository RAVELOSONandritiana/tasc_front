<script lang="ts">
	...
	import { User, Mail, Phone, MapPin, Calendar, Shield, ArrowLeft, History, BookOpen, GraduationCap, CheckCircle2 } from '@lucide/svelte/icons';
...
<main class="flex min-h-0 flex-1 flex-col overflow-y-auto bg-background text-foreground">
	<div class="space-y-6 p-4 md:p-6">
		...
		<Card class="overflow-hidden">
			...
			<div class="px-6 pb-6">
				<div class="-mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-end sm:justify-between">
			...
			<Card class="space-y-3 p-4">
				...
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm font-medium">{user.domicile}{user.commune ? `, ${user.commune}` : ''}</p>
					</div>
				</div>
			</Card>
