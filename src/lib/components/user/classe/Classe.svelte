...
>
	{#if deleteAction}
		...
		<ConfirmDeleteDialog
			...
			description="Êtes-vous sûr de vouloir supprimer la classe {c.nom} ? Cette action est irréversible et supprimera également les élèves et cours associés."
									...
									>
										<div class="flex items-center gap-2">
											...
											<span class="text-sm font-medium">
												{editSelectedProf.name}
												{editSelectedProf.lastname}
											</span>
										</div>
										<button
											type="button"
